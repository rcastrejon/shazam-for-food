...
**Step 1**:
Think step-by-step in 'thinking' field and analyze every part of the image. You will be as descriptive as possible; describe the portions, harmony of flavors, and your certainty about each ingredient.
...
**Paso 1**:
Piensa paso a paso en el campo 'thinking' y analiza cada parte de la imagen. Sé lo más descriptivo posible; describe las porciones, la armonía de sabores y tu certeza sobre cada ingrediente.
...
- Las casillas de verificación sólo deben utilizarse para despejar dudas. Si está seguro de un ingrediente, no debe incluirlo.
